...
function StatCard({ label, value, icon, iconBg, iconColor, indicator }: StatCardProps) {
  return (
    <Card className="p-6">
      <CardContent className="p-0">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p
              className="mt-2 text-[32px] font-bold tabular-nums text-foreground"
              style={{ fontFamily: "'Satoshi', sans-serif" }}
            >
              {value}
            </p>
            {indicator && (
              <p className="mt-1 text-xs text-muted-foreground">{indicator}</p>
            )}
          </div>
          <div
